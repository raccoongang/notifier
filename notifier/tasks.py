...
def generate_and_send_digests(users, from_dt, to_dt, language=None, broad=None):
    """
...
def do_forums_digests(self, broad=None):
    ...
    try:
        for user_batch in batch_digest_subscribers():
            generate_and_send_digests.delay(user_batch, from_dt, to_dt, language=settings.LANGUAGE_CODE, broad=broad)
